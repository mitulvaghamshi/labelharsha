    ...
    <section className="container" id="contact">
      <div className="section-header">
        ...
        <p className="section-desc">
          Walk in to experience our vibrant fabrics or contact us directly to
          convince styled orders and alterations.
        </p>
      </div>
        ...
        <div className="contact-info-panel">
          <div className="info-card">
            ...
            <InfoRow icon={icons.clock} title="Boutique Hours">
              <p>
                Mon - Sat: 09:00 AM to 09:00 PM (IST)<br />Sunday: By
                Appointment Only
              </p>
            </InfoRow>
            ...
            <InfoRow icon={icons.phone} title="Reservations & Styling Phone">
              ...
              &nbsp;&nbsp;
              <a
                href="https://www.instagram.com/labelharsha"
                target="_blank"
                rel="noopener noreferrer"
                className="btn-primary"
                style={{ padding: "8px 18px", textTransform: "capitalize" }}
            ...
            <InfoRow icon={icons.map} title="Boutique Address">
              <address>
                Label Harsha, 36, Sarva Mangal Park, Behind Palika Nagar, Bakrol
                Part, Anand, Gujarat - 388315
              </address>
            </InfoRow>
          </div>
        </div>
