    ...
    return (
        <header className="hero-section" id="home">
            <div className="hero-content">
                ...
                <p className="hero-desc">Express your color. Premium readymade ethnic and fusion wear designed with exquisite handcraft and handpicked vibrant fabrics.</p>
                <div className="hero-cta">
                    ...
                    <a href="#contact" className="btn-secondary">Visit Boutique</a>
                </div>
            </div>
        </header>
    );
